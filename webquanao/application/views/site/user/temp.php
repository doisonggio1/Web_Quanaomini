            ...
            <div class="panel panel-info">
                ...
                <div class="info-row">
                    <div class="info-label">
                        ...
                        <div class="content" id="name"><?php echo $user->name ?></div>
                    </div>
                ...
                <div class="info-row">
                    <div class="info-label">
                        ...
                        <div class="content" id="phone"><?php echo $user->phone ?></div>
                    </div>
                    <div class="info-buttons">
                        <button class="btn btn-delete">
                            <i class="fa-solid fa-trash"></i>
                ...
                <div class="info-row">
                    <div class="info-label">
                        ...
                        <div class="content" id="email"><?php echo $user->email ?></div>
                    </div>
                    <div class="info-buttons">
                        <button
                            class="btn btn-edit"
                ...
                <div class="info-row">
                    <div class="info-label">
                        ...
                        <div class="content" id="address">
                            ...
                            $cleanAddress = implode(", ", $filteredValues);
