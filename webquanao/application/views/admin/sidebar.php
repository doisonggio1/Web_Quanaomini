<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
	...
	<ul class="nav menu">
		<li class="active"><a href="<?php echo admin_url('home'); ?>"><svg class="glyph stroked home"><use xlink:href="#stroked-home"/></svg> Trang chủ</a></li>
		<li><a href="<?php echo admin_url('catalog'); ?>"><svg class="glyph stroked clipboard with paper"><use xlink:href="#stroked-clipboard-with-paper"/></svg> Danh mục</a></li>
		<li><a href="<?php echo admin_url('product'); ?>"><svg class="glyph stroked bag"><use xlink:href="#stroked-bag"></use></svg> Sản phẩm</a></li>
